...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sj_doctrine_encryption.doctrine_subscriber' => 'getSjDoctrineEncryption_DoctrineSubscriberService',
            'sj_doctrine_encryption.encryptor_container' => 'getSjDoctrineEncryption_EncryptorContainerService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('sj_doctrine_encryption.doctrine_subscriber'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'sjdoctrineencrypt', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/SJ/ExampleBundle/Entity'))), 'SJ\\ExampleBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SJExampleBundle' => 'SJ\\ExampleBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_433ba4784e1b52e04583175cac4b9d5e65784d1bc69f33240a7223cad2aae91d');
    ...
    /**
     * Gets the 'sj_doctrine_encryption.doctrine_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SJ\DoctrineEncryptionBundle\EventListener\SJDoctrineEventSubscriber A SJ\DoctrineEncryptionBundle\EventListener\SJDoctrineEventSubscriber instance.
     */
    protected function getSjDoctrineEncryption_DoctrineSubscriberService()
    {
        return $this->services['sj_doctrine_encryption.doctrine_subscriber'] = new \SJ\DoctrineEncryptionBundle\EventListener\SJDoctrineEventSubscriber($this->get('sj_doctrine_encryption.encryptor_container'));
    }

    /**
     * Gets the 'sj_doctrine_encryption.encryptor_container' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SJ\DoctrineEncryptionBundle\Services\EncryptorContainer A SJ\DoctrineEncryptionBundle\Services\EncryptorContainer instance.
     */
    protected function getSjDoctrineEncryption_EncryptorContainerService()
    {
        return $this->services['sj_doctrine_encryption.encryptor_container'] = new \SJ\DoctrineEncryptionBundle\Services\EncryptorContainer('SJ\\DoctrineEncryptionBundle\\Encryptors\\TestEncryptor', '0a3284973868a1373b284d9d1bacdb67eca89ea8');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SJ/ExampleBundle/Resources/views'), 'SJExample');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0a3284973868a1373b284d9d1bacdb67eca89ea8');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('571c485b5eb5c1.49848447')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SJExampleBundle' => 'SJ\\ExampleBundle\\SJExampleBundle',
                'SJDoctrineEncryptionBundle' => 'SJ\\DoctrineEncryptionBundle\\SJDoctrineEncryptionBundle',
            ...
            'database_port' => 8889,
            'database_name' => 'sjdoctrineencrypt',
            'database_user' => 'root',
            ...
            'secret' => '0a3284973868a1373b284d9d1bacdb67eca89ea8',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '0a3284973868a1373b284d9d1bacdb67eca89ea8',
            ...
            'sj_doctrine_encryption.encryptor_class' => 'SJ\\DoctrineEncryptionBundle\\Encryptors\\TestEncryptor',
            'sj_doctrine_encryption.encryption_key' => '0a3284973868a1373b284d9d1bacdb67eca89ea8',
